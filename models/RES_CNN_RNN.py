...
class RES_CNN_RNN(BasicModel):
    def __init__(self, device, vocab_size, word_embed = None, dim_word_embed = 100):
        super(RES_CNN_RNN, self).__init__(device)
    ...
    def forward(self, arr_x, doc_lens):
        ...
        arr_x = arr_x.permute(0,2,1)
        arr_x = self.word_convs[0](arr_x) + arr_x
        arr_x = self.word_convs[1](arr_x) + arr_x
        arr_x = self.word_convs[2](arr_x) + arr_x
